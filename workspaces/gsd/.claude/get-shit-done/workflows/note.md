...
- **Global scope**: `/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/notes/`)
...
2. Glob `/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/notes/` — works in any directory
