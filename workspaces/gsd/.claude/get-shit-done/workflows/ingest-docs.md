...
```bash
INIT=$(node "/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
