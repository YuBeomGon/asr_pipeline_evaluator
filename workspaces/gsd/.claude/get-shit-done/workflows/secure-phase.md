...
```
Agent(
  prompt="Read /home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/get-shit-done/templates/SECURITY.md`
