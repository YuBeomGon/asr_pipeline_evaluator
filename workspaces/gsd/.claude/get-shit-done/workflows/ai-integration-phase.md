...
<required_reading>
@/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/get-shit-done/references/ai-frameworks.md
@/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/agents/gsd-eval-planner.md for instructions.
