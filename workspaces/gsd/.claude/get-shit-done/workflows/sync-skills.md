...
INSTALL_JS_GLOBAL="/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
