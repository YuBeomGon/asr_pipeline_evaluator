...
- Usage: Reference from command with `@/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
