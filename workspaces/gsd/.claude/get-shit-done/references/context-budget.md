...
The keys live in `.claude/settings.json` (project) or `/home/beomgon/side/asr-pipeline-evaluator/workspaces/gsd/.claude/settings.json` (global) — **not** in `.planning/config.json`:
